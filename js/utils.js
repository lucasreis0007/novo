...
const ICONES_POR_PALAVRA = [
    [["uber", "99", "taxi", "corrida", "carro", "combustivel", "gasolina", "transporte", "onibus", "metro", "estacionamento"], "transporte"],
    ...
    [["lazer", "cinema", "show", "viagem", "passeio"], "lazer"],

...
function popularCategorias() {
    ...
    categorias.saida.forEach(item => {
        categoriaSelect.innerHTML += `<option value="${item.nome}">${iconeCategoria(item.nome)} ${item.nome}</option>`;
    });
}
        ...
        card.innerHTML = `
            <div class="orcamento-topo">
                <div class="orcamento-titulo-bloco">
                    <span class="orcamento-titulo">${iconeCategoria(orc.categoria)} ${orc.categoria}</span>

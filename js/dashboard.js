...
movimentacoes.forEach((mov) => {
    ...
    if (mov.tipo === "Entrada") {
        ...
        switch (mov.natureza) {
            ...
            case "Resgate":
                // Dinheiro que estava guardado na reserva volta pro saldo
                // disponível: sai da reserva e entra como entrada de verdade
                // (o gasto em si só vai contar como despesa quando o dinheiro
                // sair do saldo disponível, numa movimentação separada).
                reservas -= mov.valor;
                entradas += mov.valor;
                saldoDisponivel += mov.valor;
                break;
...
// linha ~63, e historico.js/relatorios.js, que usam a mesma regra) ----------------

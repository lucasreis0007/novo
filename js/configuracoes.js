...
document.getElementById("btnExportarCsv").addEventListener("click", () => {
    ...
    const cabecalho = ["Data", "Tipo", "Natureza", "Categoria", "Banco", "Descrição", "Valor"];
    ...
    // \uFEFF no início garante acentuação correta ao abrir no Excel
    baixarArquivo("movimentacoes.csv", "\uFEFF" + csv, "text/csv;charset=utf-8;");
});
